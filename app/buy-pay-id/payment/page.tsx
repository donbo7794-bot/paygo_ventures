...
export default function PaymentPage() {
  ...
  const handleCopyAmount = () => {
    navigator.clipboard.writeText("6,700")
    setCopiedAmount(true)
    setTimeout(() => setCopiedAmount(false), 2000)
  }

  const handleCopyAccountNumber = () => {
    navigator.clipboard.writeText("6804091115")
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-right">
            <div className="text-xl font-bold">NGN 6,700</div>
          ...
          <div className="bg-gray-100 p-4 space-y-6">
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="font-bold">NGN 6,700</p>
                <button
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="font-bold">6804091115</p>
                <button
            ...
            <div>
              ...
              <p className="font-bold">GBENGA JULIUS AKINNUOYE</p>
            </div>
          </div>
